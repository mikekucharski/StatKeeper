...
public class TeamsListActivity extends ListActivity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dba = new DBAdapter(TeamsListActivity.this);
		dba.open();
	...
	private void editOrDelete(final String teamInQuestion){
		AlertDialog.Builder dialog = new AlertDialog.Builder(TeamsListActivity.this);
	...
	protected void editListItem(String teamName) {
			Intent ourIntent = new Intent(TeamsListActivity.this, EditTeamActivity.class);
			Bundle b = new Bundle();
			b.putString("team_name", teamName);
			ourIntent.putExtras(b);
			TeamsListActivity.this.startActivity(ourIntent);
	...
	private void addNewEntry(){
		...
		Intent ourIntent = new Intent(TeamsListActivity.this, NewTeamActivity.class);
		TeamsListActivity.this.startActivity(ourIntent);
	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent ourIntent = new Intent(TeamsListActivity.this, GameListActivity.class);
